...
```
fun main() {
    println(zhangweiGreeting(age = 6))                      
    println(zhangweiGreeting("qinjunjie", 3))               
}

fun zhangweiGreeting(name: String = "2025003036", age: Int): String {
