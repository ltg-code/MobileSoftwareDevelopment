...
```
fun main() {
    println("My name is zhushuang")
    println("My student ID is 2025003039")
...
```
fun main() {
    println("'Student [2025003039] says hello'")
}
---
...
```
fun main() {
    println("'Hello, my name is [zhushuang]'")
}
---
...
```
fun main() {
    println("ID: [2025003039]") 
    println("Name: [zhushuang]") 
...
```
fun main() {
    val name: String = "zhushuang"
    val ID: String = "2025003039"
...
```
fun main() {
    val studentName: String = "zhushuang"   
	val score: Int = 39          
	val bonus: Int = 9           
	val total: Int = score + bonus
...
```
fun main() {
    val operandOne: Int = 30  
	val operandTwo: Int = 9          
...
```
fun main() {
    println(zhushuangGreeting(age = 9))  
    println(zhushuangGreeting("zhushuang", 3))
}

fun zhushuangGreeting(name: String = "2025003039", age: Int): String {
...
```
fun main() {
    printZhushuangWeather("Ankara", 27, 31, 82)
    printZhushuangWeather("Tokyo", 32, 36, 10)
    printZhushuangWeather("Cape Town", 59, 64, 2)
    printZhushuangWeather("Guatemala City", 50, 55, 7)
}

fun printZhushuangWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
    println("City: $city")
